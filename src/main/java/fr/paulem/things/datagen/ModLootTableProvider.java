...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        sameDropWithSilkTouch(ModBlocks.RUBY_ORE, ModItems.RAW_RUBY);
        sameDropWithSilkTouch(ModBlocks.NETHER_RUBY_ORE, ModItems.RAW_RUBY);
        sameDropWithSilkTouch(ModBlocks.DEEPSLATE_RUBY_ORE, ModItems.RAW_RUBY);
        sameDropWithSilkTouch(ModBlocks.END_STONE_RUBY_ORE, ModItems.RAW_RUBY);
